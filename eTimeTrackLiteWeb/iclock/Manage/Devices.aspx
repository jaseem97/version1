                    ...
                    <div id="div_Employees">
                        <obout:Grid ID="grid_Devices" runat="server" AllowRecordSelection="true" AllowMultiRecordSelection="true"
                            ...
                            <Columns>
                                ...
                                <obout:Column Width="100" ConvertEmptyStringToNull="False" Index="16" TemplateId="tplViewUsersInDeviceBtn">
                                ...
                                <obout:Column HeaderText="Edit" Width="45" AllowEdit="True" AllowDelete="True" ConvertEmptyStringToNull="False"
                                    Index="20" TemplateId="tplEditBtn">
                                ...
                                <obout:Column ID="Column19" DataField="FaceDeviceType" Visible="false" Width="300"
                                    HeaderText="FaceDeviceType" ConvertEmptyStringToNull="False" Index="22" />
                                <obout:Column ID="Column20" DataField="MasterId" Visible="false" Width="300" HeaderText="MasterId"
                                    ConvertEmptyStringToNull="False" Index="23" />
                                <obout:Column ID="Column21" DataField="DeviceActivationCode" Visible="False" Width="300" HeaderText="C5"
        ...
        return false;
		    ...
		    function populateEditControls(iRecordIndex) 
                ...
                document.getElementById('<%=txt_TimeOut.ClientID %>').disabled=false; 
		             ...
		             document.getElementById("<%=txtCenterId.ClientID%>").value = grid_Devices.Rows[iRecordIndex].Cells[17].Value;
		             document.getElementById("<%=txtUserName.ClientID%>").value = grid_Devices.Rows[iRecordIndex].Cells[18].Value;
		             document.getElementById("<%=txtPassword.ClientID%>").value = grid_Devices.Rows[iRecordIndex].Cells[19].Value;
                     document.getElementById("<%=drp_FaceDeviceType.ClientID %>").value = grid_Devices.Rows[iRecordIndex].Cells[22].Value;
                     document.getElementById("<%=txtDeviceActivationCode.ClientID %>").value = grid_Devices.Rows[iRecordIndex].Cells[24].Value;
            ...
            function clearFlyout()
            {
                ...
                document.getElementById("<%=txtDeviceActivationCode.ClientID%>").value = '';
